...
// fill color
if(array_key_exists('fillcolor',$_GET) && !empty($_GET['fillcolor'])){
    $fillcolor = '#'.$_GET['fillcolor'];
} else {
    $fillcolor = "#CC0000";
}
if(array_key_exists('bordercolor',$_GET) && !empty($_GET['bordercolor'])){
